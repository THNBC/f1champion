      ...
      <div className="flex flex-col gap-4">
        ...
        {isLogged && (
          <button
            ...
            className="rounded-xl border border-zinc-800 p-3 text-xs font-black uppercase tracking-wide text-zinc-500 transition hover:bg-red-600/10 hover:text-red-500"
          >
            Logout
          </button>
        )}
